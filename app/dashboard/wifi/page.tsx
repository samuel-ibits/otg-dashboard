...
import { VoucherSubscriptions } from "@/app/components/VoucherSubscriptions";
...
export default function WiFiPage() {
    ...
    const tabs = [
        ...
        { label: "Voucher Subscriptions", value: "voucher-subscriptions" },
    ];
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-bold text-gray-900">Wi-Fi Management</h1>
                    <p className="text-sm text-gray-500">Manage and monitor your Wi-Fi plans and sessions</p>
                </div>
            ...
            <div className="mt-6">
                ...
                {activeTab === "voucher-subscriptions" && <VoucherSubscriptions />}
            </div>
        </div>
    );
}
